...
class PageStyle
{
    ...
    /**
     * Sepcifies default number format for page styles, which is used to display page numbers within headers and
     * footers.
     *
     * @param string $prefix
     * @param string $suffix
     ...
     */
    public function setPageNumberFormat($prefix, $suffix, $format)
    {
     ...
     */
    public function setHorizontalMargin($leftMargin = 0, $rightMargin = 0)
    {
     ...
     */
    public function setVerticalMargin($topMargin, $bottomMargin)
    {
     ...
     * @param int|length $borderWidth Can be a length, or one of these values: StyleConstants::(THIN|THICK|MEDIUM)
     */
    public function setBottomBorder(
        $borderColor = '#000000',
        $borderStyle = StyleConstants::SOLID,
        $borderWidth = StyleConstants::THIN
    ) {
     ...
     * @param int|length $borderWidth Can be a length, or one of these values: StyleConstants::(THIN|THICK|MEDIUM)
     */
    public function setRightBorder(
        $borderColor = '#000000',
        $borderStyle = StyleConstants::SOLID,
        $borderWidth = StyleConstants::THIN
    ) {
     ...
     * @param string $position Do not use this, it's for internal use only.
     */
    public function setPadding($padding, $position = '')
    {
     ...
     * @param length $height
     */
    public function setMaximumFootnoteHeight($height)
    {
        if (!isNumeric($height)) {
    ...
    public function setFootnoteSeparator(
        $lineWidth = '1mm',
        $color = '#000000',
        $adjustment = StyleConstants::CENTER,
        $distanceBefore = '5mm',
        $distanceAfter = '5mm',
     ...
     * @param length $height
     */
    public function setHeadFootHeight($element, $height)
    {
     ...
     * @param length $height
     */
    public function setHeadFootMinHeight($element, $minHeight)
    {
    ...
    public function setHeaderMinHeight($minHeight)
    {
     ...
     * @param integer|string $rightMargin
     */
    public function setHeadFootHMargins($element, $leftMargin = 0, $rightMargin = 0)
    {
        if (!isNumeric($leftMargin) && !isLengthValue($leftMargin)) {
            throw new StyleException('Invalid left-margin value');
        }
    ...
    public function setHeaderHMargins($leftMargin = 0, $rightMargin = 0)
    {
        $this->setHeadFootHMargins('header', $leftMargin, $rightMargin);
    }

    public function setFooterHMargins($leftMargin = 0, $rightMargin = 0)
    {
     ...
     * @param integer|string $bottomMargin
     */
    public function setHeadFootVMargins($topMargin, $bottomMargin)
    {
        if (!isNumeric($topMargin, true) && !isLengthValue($topMargin, true)) {
            throw new StyleException('Invalid top-margin value');
        }
    ...
    public function setHeaderVMargins($topMargin = 0, $bottomMargin = 0)
    {
        $this->setHeadFootHMargins('header', $topMargin, $bottomMargin);
    }

    public function setFooterVMargins($topMargin = 0, $bottomMargin = 0)
    {
     ...
     * @param string $position Do not use this, it's for internal use only.
     */
    public function setHeadFootBorder(
        $element,
        $borderColor = '#000000',
        $borderStyle = StyleConstants::SOLID,
        $borderWidth = StyleConstants::THIN,
    ...
    public function setHeaderBorder(
        $borderColor = '#000000',
        $borderStyle = StyleConstants::SOLID,
        $borderWidth = StyleConstants::THIN
    ) {
    ...
    public function setHeaderTopBorder(
        $borderColor = '#000000',
        $borderStyle = StyleConstants::SOLID,
        $borderWidth = StyleConstants::THIN
    ) {
    ...
    public function setHeaderBottomBorder(
        $borderColor = '#000000',
        $borderStyle = StyleConstants::SOLID,
        $borderWidth = StyleConstants::THIN
    ) {
    ...
    public function setHeaderLeftBorder(
        $borderColor = '#000000',
        $borderStyle = StyleConstants::SOLID,
        $borderWidth = StyleConstants::THIN
    ) {
    ...
    public function setHeaderRightBorder(
        $borderColor = '#000000',
        $borderStyle = StyleConstants::SOLID,
        $borderWidth = StyleConstants::THIN
    ) {
     ...
     * @param string $position Do not use this, it's for internal use only.
     */
    public function setHeadFootPadding($element, $padding, $position = '')
    {
        if (!isLengthValue($padding, true) && !isNumeric($padding)) {
            throw new StyleException('Invalid padding value');
        }
    ...
    public function setHeaderPadding($padding, $position = '')
    {
    ...
    public function setHeaderTopPadding($padding)
    {
    ...
    public function setHeaderBottomPadding($padding)
    {
    ...
    public function setHeaderLeftPadding($padding)
    {
    ...
    public function setHeaderRightPadding($padding)
    {
     ...
     * @param color $color
     */
    public function setHeadFootBackgroundColor($element, $color)
    {
        if ($color != StyleConstants::TRANSPARENT && !isColor($color)) {
     ...
     * Valid values are StyleConstants::(LEFT|RIGHT|CENTER|TOP|BOTTOM)
     */
    public function setHeadFootBackgroundImage(
        $element,
        $image,
        $repeat = StyleConstants::REPEAT,
    ...
    public function setHeaderBackgroundImage(
        $image,
        $repeat = StyleConstants::REPEAT,
        $position = StyleConstants::CENTER
    ) {
    ...
    public function setHeadFootContent($element, $content, $paragraphStyles = null)
    {
        ...
        } elseif ($content == StyleConstants::CURRENT_DATE) {
    ...
    public function setHeaderContent($content, $paragraphStyles = null)
    {
        $this->setHeadFootContent('style:header', $content, $paragraphStyles);
    }

    public function setFooterContent($content, $paragraphStyles = null)
    {
