...
class ParagraphStyle extends Style
{
     ...
     */
    public function setLineDistance($distance)
    {
     ...
     */
    public function setKeepTogether($keepTogether = StyleConstants::ALWAYS)
    {
        switch ($keepTogether) {
     ...
     */
    public function setHorizontalMargins($leftMargin = 0, $rightMargin = 0)
    {
     ...
     */
    public function setKeepWithNext()
    {
        $element = $this->styleDocument->createElement('style:paragraph-properties');
