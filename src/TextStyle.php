...
class TextStyle extends Style
{
    ...
    public function setTextTransform($transform)
    {
        ...
        switch ($transform) {
            ...
            case StyleConstants::LOWER_CASE:
                $attrTransform = 'lowercase';
                break;
            case StyleConstants::UPPER_CASE:
                $attrTransform = 'uppercase';
                break;
            case StyleConstants::CAPITALIZE:
                $attrTransform = 'capitalize';
                break;
            default:
     ...
     */
    public function setTextOutline($outline = true)
    {
        $element = $this->styleDocument->createElement('style:text-properties');
     ...
     */
    public function setLineThrough($lineType = StyleConstants::SINGLE, $lineWidth = StyleConstants::NORMAL)
    {
        switch ($lineType) {
            case StyleConstants::NONE:
                $lineType = 'none';
...
//  }
     ...
     */
    public function setFontRelief($fontRelief)
    {
        switch ($fontRelief) {
     ...
     */
    public function setTextShadow($shadowColor = '#000000', $xCoord = 5, $yCoord = 5, $blurRadius = 0)
    {
     ...
     * @param integer $underlineStyle Valid values: StyleConstants::SOLID, StyleConstants::DOTTED, StyleConstants::DASH,
     *  StyleConstants::LONG_DASH, StyleConstants::DOT_DOT_DASH, StyleConstants::WAVE
     * @param integer $underlineWidth Valid values: StyleConstants::AUTO, StyleConstants::NORMAL, StyleConstants::BOLD,
     *  StyleConstants::THIN, StyleConstants::DASH, StyleConstants::MEDIUM, StyleConstants::THICK
     * @param color $underlineColor a valid color
     */
    public function setTextUnderline(
        $underlineType = StyleConstants::SINGLE,
        ...
        switch ($underlineStyle) {
            ...
            case StyleConstants::LONG_DASH:
                $underlineStyle = 'long-dash';
                break;
            case StyleConstants::DOT_DOT_DASH:
                $underlineStyle = 'dot-dot-dash';
                break;
        ...
        switch ($underlineWidth) {
            case StyleConstants::AUTO:
                $underlineWidth = 'single';
                break;
            case StyleConstants::NORMAL:
                $underlineWidth = 'normal';
                break;
            case StyleConstants::BOLD:
                $underlineWidth = 'bold';
                break;
...
//              throw new StyleException('Invalid underline-type value.');
     ...
     */
    public function setUnderlineWordMode($mode)
    {
        switch ($mode) {
     ...
     * @param integer $mode Valid values are StyleConstants::CONTINUOUS, StyleConstants::SKIP_WHITE_SPACE
     */
    public function setLineThroughWordMode($mode)
    {
        switch ($mode) {
            case StyleConstants::CONTINUOUS:
                $mode = 'continuous';
...
//  }
     ...
     */
    public function setTextBlinking()
    {
        $element = $this->styleDocument->createElement('style:text-properties');
     ...
     * If the value is StyleConstants::LINES, all characters with this attribute value that immediately follow each
     * other are displayed within two lines of approximately the same length. There can be a line break between
     ...
     */
    public function setTextCombine($textCombine, $startChar = '', $endChar = '')
    {
        switch ($textCombine) {
